...
export const ServiceAreaRequestedPage = () => (
  <div className="mx-auto w-full max-w-4xl px-4 py-14 md:px-8 md:py-20">
    <Card className="space-y-6 border-stroke bg-surface p-7 md:p-10">
      <h1 className="font-display text-4xl font-bold text-ink md:text-5xl">Thank you for your request</h1>
      <p className="text-base text-copy-muted md:text-lg">
