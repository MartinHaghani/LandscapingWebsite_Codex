...
export const QuoteProgressRail = ({ currentStep }: QuoteProgressRailProps) => {
  const currentIndex = getStepIndex(currentStep);
  ...
  return (
    <div className="relative mt-8 overflow-hidden rounded-[32px] border border-stroke bg-surface shadow-soft">
