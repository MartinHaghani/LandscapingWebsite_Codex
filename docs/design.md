...
- Live status on 2026-04-21 keeps this separation intact: staging is active with PostgreSQL 16/PostGIS and self-managed GoDaddy CNAMEs, while production is intentionally uncreated until the remaining authenticated smoke tests pass.
