...
5. Production deploys automatically from `main` to the DigitalOcean `autoscape-production` app after staging smoke tests pass; the live production app now serves `autoscape.ca`, `www.autoscape.ca`, `api.autoscape.ca`, and `admin.autoscape.ca`.
