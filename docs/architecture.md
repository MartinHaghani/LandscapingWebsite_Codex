...
- Public layout shell: `client/src/components/layout/SiteLayout.tsx` (`Navbar`, `Footer`, `ScrollToTop`; signed-out desktop auth links use a slim divider rather than punctuation)
